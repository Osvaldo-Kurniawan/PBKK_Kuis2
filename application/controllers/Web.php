...
class Web extends CI_Controller {
	...
	{
		$ceks = $this->session->userdata('surat_menyurat@Kuis2-PBKK-A');
		if(!isset($ceks)) {
			redirect('web/login');
		}else{
					redirect('users');
								 ...
								 redirect('web/login');
										 ...
										 if($cekpass <> $pass) {
												...
												redirect('web/login');
																...
																$this->session->set_userdata('surat_menyurat@Kuis2-PBKK-A', "$cekun");
																$this->session->set_userdata('id_user@Kuis2-PBKK-A', "$row->id_user");
	...
	public function logout() {
     if ($this->session->has_userdata('surat_menyurat@Kuis2-PBKK-A') and $this->session->has_userdata('id_user@Kuis2-PBKK-A')) {
